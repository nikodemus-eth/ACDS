"""Configuration for the OpenShell Layer.

OpenShellConfig holds all tunables governing filesystem scope,
...
class OpenShellConfig:
    """Runtime configuration for the OpenShell dispatch pipeline."""
    ...
    @classmethod
    def for_run(cls, openclaw_root: Path, run_id: str) -> OpenShellConfig:
        ...
        return cls(
            ...
            artifact_root=str(workspace / "openshell" / "artifacts"),
            ledger_root=str(workspace / "openshell" / "ledger"),
