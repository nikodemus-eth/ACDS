"""OpenShell Dispatcher — pipeline orchestrator for governed command execution.
...
class OpenShellDispatcher:
    """Governed execution gateway for OpenShell commands.
    ...
    def __init__(self, config: OpenShellConfig) -> None:
        ...
        # OpenShell-specific adapters (not ToolAdapters)
        from swarm.openshell.adapters.filesystem import FilesystemAdapter
        from swarm.openshell.adapters.http import HttpAdapter
        from swarm.openshell.adapters.report import ReportAdapter
        from swarm.openshell.adapters.tts import TtsAdapter
    ...
    def handles(self, tool_name: str) -> bool:
        """Return True if tool_name is an OpenShell-registered command."""
