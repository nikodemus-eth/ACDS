"""Tests for swarm.openshell.ledger_writer — LedgerWriter."""
...
from swarm.openshell.ledger_writer import GENESIS_HASH, LedgerWriter
...
class TestLedgerWriterAppend:
    ...
    def test_ledger_file_created(self, config):
        ...
        ledger_path = Path(config.ledger_root) / "openshell_ledger.jsonl"
