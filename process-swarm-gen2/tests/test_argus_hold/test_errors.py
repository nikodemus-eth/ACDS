"""Tests for swarm.argus_hold.errors — error subclass attributes."""

from __future__ import annotations

from swarm.argus_hold.errors import (
    ARGUSHoldError,
    PolicyDeniedError,
    ScopeViolationError,
    ValidationError,
...
class TestScopeViolationError:
    ...
    def test_scope_violation_error_inherits_argus_hold_error(self):
        e = ScopeViolationError("bad scope", ["v1"])
        try:
            raise e
        except ARGUSHoldError as caught:
            assert caught is e
