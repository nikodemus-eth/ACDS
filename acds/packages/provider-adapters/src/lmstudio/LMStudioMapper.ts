...
export function toLMStudioRequest(request: AdapterRequest): LMStudioChatRequest {
...
export function fromLMStudioResponse(response: LMStudioChatResponse, latencyMs: number): AdapterResponse {
