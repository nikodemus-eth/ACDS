...
const instance = new InMemoryAdaptationRollbackReadRepository();

export function getAdaptationRollbackReadRepository(): InMemoryAdaptationRollbackReadRepository {
  return instance;
}
